...
from .views import (private_message_detail_list_send, private_message_list, private_message_create,
                    group_message_list_create, group_message_detail_list_send, group_message_list_joined,
...
urlpatterns = [
    ...
    path('group/joined',                                            group_message_list_joined,              name='group-message-list-joined'),
